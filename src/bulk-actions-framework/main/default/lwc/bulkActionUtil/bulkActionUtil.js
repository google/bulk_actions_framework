...
const getConstants = () => {
  return {
    ...
    HELPTEXT_CSS:
      "slds-popover slds-popover_tooltip slds-nubbin_top-right slds-fall-into-ground slds-hide helptextCustom",
    HELPTEXT_OPEN_CSS:
      "slds-popover slds-popover_tooltip slds-nubbin_top-right slds-rise-from-ground helptextCustom",
    RECORD_DETAIL_LINK_COLUMN: {
      label: "",
      fieldName: "link",
      initialWidth: 40,
      type: "url",
    ...
    ACTION_COLUMN: {
      ...
      initialWidth: 200,
      typeAttributes: {
        rowActions: [{ label: "View Error Details", name: "viewError" }]
      }
    }
  };
};
...
const getTableType = () => {
  return {
    ELIGIBLE_RECORDS: {
      LABEL: "EligibleRecords",
      HEADER: "Records meeting action criteria",
      ICON: "action:check",
      CLASS: "eligible-icn"
    },
    NON_ELIGIBLE_RECORDS: {
      LABEL: "NonEligibleRecords",
      HEADER: "Records not meeting action criteria",
      ICON: "action:reject",
      CLASS: "non-eligible-icn"
    },
    ACTION_RESULT: {
      LABEL: "ActionResult",
      HEADER: "Results",
